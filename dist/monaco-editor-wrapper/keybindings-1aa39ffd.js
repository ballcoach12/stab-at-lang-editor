import { bq as S, qD as T, qE as _, qF as A, qG as Xe, aG as g, B as r, qH as Ze, w as me, iU as X, au as Ue, ao as D, iW as et, bM as E, aE as P, iy as N, _ as fe, a as K, ag as tt, bW as Z, aI as nt, a9 as Re, aY as it, bv as ot, ah as $e, g as pe, h as st, aX as Ge, qI as Oe, N as ge, pT as rt, bz as V, qJ as at, bx as ie, a0 as Se, b4 as ke, qK as dt, qL as ct, a2 as ve, qM as ut, c1 as oe, bp as we, qN as lt, qO as w, qP as ht, qQ as Y, qR as v, bf as qe, D as F, E as U, bc as Fe, L as J, cJ as yt, e7 as We, pN as je, e0 as ae, fi as mt, qS as Q, hY as Be, qT as xe, qU as ft, qV as Ne, qW as pt, qX as Ie, qt as gt, aa as bt, aL as Ct, pP as Kt, qY as Le, e as _t, dx as St, ai as kt, aj as vt, ak as wt, ad as Ye, le as Te, qZ as xt, q_ as It, qb as Lt, k as se, t as Tt } from "./index-4b7b8e94.js";
import { g as At } from "./unboundCommands-6da4f3ee.js";
import "./workbench.contribution-0a54d166.js";
...
class de {
  ...
  static parseKeybinding(e) {
    ...
    return t.length > 0 ? new Xe(t) : null;
  }
}
const ze = [
  {
...
const Ae = new me(), Ve = X.registerExtensionPoint({
...
const G = /* @__PURE__ */ new Map(), He = X.registerExtensionPoint({
...
const Et = new Map(ze.map((l) => [l.key, l])), De = new me(), re = /* @__PURE__ */ new Map(), Mt = X.registerExtensionPoint({
...
class Qt extends vt {
  ...
  run(e) {
    e.get(Ye).toggleLogging() && e.get(Z).executeCommand(Dt);
  }
}
kt(Qt);
async function rn(l) {
...
function an() {
  return {
    ...Lt(),
    [Ye.toString()]: new se(Xt, [], !1),
    [Oe.toString()]: new se(he, void 0, !0),
    [Z.toString()]: new se(ye, [], !0)
  };
}
export {
  an as default,

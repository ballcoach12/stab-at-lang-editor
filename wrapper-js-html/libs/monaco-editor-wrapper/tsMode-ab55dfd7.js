...
import { t as K, m as E } from "./verifyPrepare-778b382e.js";
/*!-----------------------------------------------------------------------------
 ...
 *-----------------------------------------------------------------------------*/
var L = Object.defineProperty, H = Object.getOwnPropertyDescriptor, V = Object.getOwnPropertyNames, W = Object.prototype.hasOwnProperty, j = (e, t, r) => t in e ? L(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, T = (e, t, r, l) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let n of V(t))
      !W.call(e, n) && n !== r && L(e, n, { get: () => t[n], enumerable: !(l = H(t, n)) || l.enumerable });
  return e;
...
var O = class extends w {
  ...
  async provideSignatureHelp(t, r, l, n) {
    ...
    const o = await a.getSignatureHelpItems(u.toString(), g, {
      triggerReason: O._toSignatureHelpTriggerReason(n)
    });
    if (!o || t.isDisposed())
      return;
    const p = {
    ...
    return o.items.forEach((d) => {
      ...
      f.documentation = {
        ...
        const v = k(h.displayParts), N = {
          label: v,
          documentation: {
            value: k(h.documentation)
          }
        };
        f.label += v, f.parameters.push(N), y < x.length - 1 && (f.label += k(d.separatorDisplayParts));
  ...
  async provideHover(e, t, r) {
    ...
    if (!g || e.isDisposed())
      return;
    const a = k(g.documentation), o = g.tags ? g.tags.map((d) => P(d)).join(`  

import { D as N, E as d, pc as A, pe as Y, O as j, k as Z, B as $, bU as E, sf as J, jx as u, eZ as q, jh as Q, c$ as ee, aR as ie, _ as B, a as D, aK as O, ab as x, fg as W, bB as m, bz as a, pf as M, p9 as h, dC as T, aG as p, pa as c, e as te, fh as R, G as _, bO as C, aI as y, bf as se, p7 as ne } from "./verifyPrepare-778b382e.js";
class re extends N {
  constructor(e, i) {
...
const b = class b extends N {
  ...
  createViewItem(e) {
    ...
    if (!i)
      return;
    const t = (s, f) => {
      const l = this._notifications.indexOf(i);
      l >= 0 && this._onDidChangeNotification.fire({ item: i, index: l, kind: s, detail: f });
...
const g = class g extends N {
  ...
  static parseNotificationMessage(e) {
    let i;
    if (e instanceof Error ? i = q(e, !1) : typeof e == "string" && (i = e), !i)
      return;
    const t = i;
  ...
  constructor(e, i, t, n, r, s, f, l) {
    super(), this.id = e, this._severity = i, this._sticky = t, this._priority = n, this._message = r, this._source = s, this._visible = !1, this._onDidChangeExpansion = this._register(new d()), this.onDidChangeExpansion = this._onDidChangeExpansion.event, this._onDidClose = this._register(new d()), this.onDidClose = this._onDidClose.event, this._onDidChangeContent = this._register(new d()), this.onDidChangeContent = this._onDidChangeContent.event, this._onDidChangeVisibility = this._register(new d()), this.onDidChangeVisibility = this._onDidChangeVisibility.event, f && this.setProgress(f), this.setActions(l);
  }
  setProgress(e) {
...
class z extends ie {
  constructor(e, i) {
    ...
    }), this._onDidRun = this._register(new d()), this.onDidRun = this._onDidRun.event, this._keepOpen = !!i.keepOpen, this._menu = !i.isSecondary && i.menu ? i.menu.map((t, n) => new z(`${e}.${n}`, t)) : void 0;
  }
  get menu() {
    return this._menu;
  }
...
class ae {
  static create(e, i) {
    if (!e || $(e))
      return;
    let t;
    if (e instanceof Error ? t = q(e, !1) : typeof e == "string" && (t = e), !!t)
      return { message: t, options: i };
  }
}
function w(o, e, i) {
  return {
    id: W(o.toString()).toString(),
    silent: i,
    source: e || "core"
  };
}
...
const V = "notifications.showList", K = "notifications.hideList", de = "notifications.toggleList", v = "notifications.hideToasts", G = "notifications.focusToasts", he = "notifications.focusNextToast", ce = "notifications.focusPreviousToast", ge = "notifications.focusFirstToast", ue = "notifications.focusLastToast", fe = "notification.collapse", le = "notification.expand", H = "notification.acceptPrimaryAction", _e = "notification.toggle", me = "notification.clear", U = "notifications.clearAll", X = "notifications.toggleDoNotDisturbMode";
function I(o, e) {
  if (L(e))
    return e;
...
function ye(o, e, i) {
  m.registerCommand(V, () => {
    ...
    handler: (n) => {
      ...
      if (!s)
        return;
      const f = (l = s.actions) != null && l.primary ? R(s.actions.primary) : void 0;
      f && (r.run(f, s), s.close());
    }
  }), a.registerCommandAndKeybindingRule({
    id: fe,
...
let F = class extends se {
  ...
  async runAction(e, i) {
    this.telemetryService.publicLog2("workbenchActionExecuted", { id: e.id, from: "message" }), L(i) && this.telemetryService.publicLog2("notification:actionExecuted", {
      id: W(i.message.original.toString()).toString(),
      actionLabel: e.label,

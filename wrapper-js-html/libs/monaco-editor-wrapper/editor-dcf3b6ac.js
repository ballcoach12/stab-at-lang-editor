import { lh as $n, q as O, y as xe, be as Qn, O as k, k as Ct, Y as Xn, a2 as Ve, a4 as Ue, K as mt, $ as ge, J as ao, b8 as ii, c6 as Ho, z as ft, lF as zo, lG as Zn, aw as Nt, lH as er, G as o, _ as I, a as h, ag as de, aO as Bi, aN as T, af as Fi, ad as qo, bY as Ni, e as ce, aR as Ze, E as R, k9 as $t, b5 as oi, a7 as tr, bc as ir, lI as or, aT as co, dw as nr, bk as v, c5 as y, al as L, lJ as De, am as C, aI as l, ae as _, ak as c, aM as et, bO as g, aG as E, aD as Ko, n as Vi, lK as At, lL as rr, lz as jo, lM as We, ah as sr, fU as ar, lN as Yo, bz as Ui, ai as Vt, lO as ni, fJ as Jo, bP as dr, bh as cr, bR as lr, lP as ur, lQ as hr, dR as pr, d0 as gr, e5 as lo, lR as mr, ed as fr, lS as Er, lT as vr, s as br, p as ie, aK as tt, ac as Pe, j7 as _e, lU as Sr, lV as yr, bE as Wi, eX as Qt, eZ as uo, eY as ri, eW as Cr, g as it, bH as wr, dA as Ge, dl as Ut, eQ as Ir, jt as wt, lW as ho, kn as oe, lX as Mr, iD as Ar, gt as $o, lY as si, lZ as Dr, da as Qo, cR as Se, aJ as kr, D as K, l_ as Lr, l$ as J, bD as Wt, bG as Xo, f as Hi, jk as zi, m0 as Rr, m1 as Tr, jq as xr, bW as Pr, jd as ae, ds as fe, dt as X, F as ee, S as Dt, m2 as po, fd as go, cM as mo, dS as _r, m3 as Gr, U as G, m4 as fo, m5 as Or, js as ot, dU as nt, bB as Zo, m6 as Br, m7 as Fr, m8 as Nr, m9 as Vr, ma as Ur, mb as Wr, mc as Hr, md as en, hq as Ce, me as ai, mf as di, mg as zr, kP as Et, hj as qi, mh as qr, av as je, mi as Kr, mj as Eo, hE as he, hi as jr, dz as tn, mk as Q, ml as Yr, fi as It, cU as Jr, bx as Ki, jz as $r, aZ as Qr, d as He, j3 as Xr, ap as on, eE as Zr, jA as ji, lq as es, jB as ts, mm as is, jW as Xt, Q as V, h_ as os, mn as vt, gr as ns, ax as pe, dF as Yi, aj as rs, ab as ss, bX as as, jx as ds, mo as rt, hx as cs, mp as ls, mq as us, eV as st, mr as vo, l as Ye, ms as ci, mt as bo, gw as Ji, hO as at, hw as hs, mu as So, mv as ps, by as gs, mw as yo, mx as nn, my as Co, mz as rn, mA as wo, mB as sn, mC as ms, mD as fs, mE as Es, mF as vs, mG as bs, mH as Ss, mI as ys, mJ as Cs, mK as ws, mL as Is, mM as Ms, mN as As, mO as an, mP as dn, mQ as Ds, mR as ks, mS as Ls, mT as Rs, mU as Ts, mV as xs, mW as $i, mX as Ps, mY as _s, mZ as Gs, m_ as Os, m$ as Bs, n0 as Fs, n1 as Ns, n2 as Vs, n3 as Us, n4 as Ws, n5 as Hs, n6 as zs, n7 as qs, n8 as Ks, n9 as js, na as Ys, nb as Js, nc as $s, nd as Qs, ne as Xs, nf as Zs, ng as ea, nh as ta, ni as ia, nj as oa, nk as na, nl as ra, nm as sa, nn as aa, no as da, np as ca, nq as la, nr as ua, ns as ha, nt as pa, nu as ga, nv as ma, nw as fa, nx as Ea, ny as va, nz as ba, nA as Sa, nB as ya, nC as Ca, nD as wa, nE as Ia, nF as Ma, nG as Aa, nH as Da, nI as ka, nJ as La, nK as Ra, nL as Ta, nM as xa, nN as Pa, nO as _a, nP as Ga, nQ as Oa, nR as Ba, nS as Fa, nT as Na, nU as cn, nV as ln, nW as un, nX as hn, nY as pn, nZ as gn, n_ as mn, n$ as fn, o0 as Va, o1 as Ua, o2 as Wa, o3 as Ha, o4 as za, o5 as qa, o6 as Ka, bA as En, o7 as ja, ez as vn, dQ as Ht, o8 as bn, o9 as zt, oa as dt, ob as qt, oc as ct, od as Sn, oe as B, e$ as Oe, gX as yn, f9 as Ya, of as Cn, dL as wn, og as lt, gY as Qi, gZ as ut, gQ as In, dN as Mn, oh as An, dJ as Ja, oi as Dn, dM as Be, oj as Kt, ok as kn, dO as Ln, ol as Rn, dP as ht, om as $a, on as Qa, oo as Xa, op as Za, f8 as jt, oq as ed, or as td, os as Fe, ot as Tn, ou as id, ov as od, ow as nd, ox as rd, oy as sd, hS as me, hT as ze, oz as li, jF as xn, dx as ad, oA as dd, bI as Pn, e9 as cd, h as _n, oB as Gn, lf as Io, fy as ld, oC as ud, aq as hd, km as pd, oD as On, jS as Zt, jY as gd, jR as md, gv as Bn, ar as Mo, oE as Ao, lx as fd, lg as Xi, gk as Zi, oF as Ed, b as vd, lD as w, oG as ui, fj as bd, eS as Do, eT as ko } from "./verifyPrepare-778b382e.js";
import { S as Sd } from "./simpleIconLabel-8cfef1f5.js";
class eo extends Ze {
  constructor(e) {
    var t;
...
let Lo = class extends kt {
  ...
  showMenu() {
    this.actions && $t(this.actions), this.actions = this.getActions(), this.contextMenuService.showContextMenu({
      getAnchor: () => this.container,
      getActions: () => this.actions,
      getCheckedActionsRepresentation: () => "radio",
      onHide: () => $t(this.actions)
    });
  }
  getActions() {
  ...
  dispose() {
    super.dispose(), this.actions && (this.actions = $t(this.actions));
  }
};
Lo = I([
  h(7, qo),
...
to.push(ye(Si.ID, E.equals("config.workbench.activityBar.visible", !0), o("activityBar", "Activity Bar"), { whenA: E.equals("config.workbench.sideBar.location", "left"), iconA: Pd, iconB: _d }), ye(wi.ID, Yo, o("sideBar", "Primary Side Bar"), { whenA: E.equals("config.workbench.sideBar.location", "left"), iconA: vi, iconB: bi }), ye(Ee.ID, De, o("secondarySideBar", "Secondary Side Bar"), { whenA: E.equals("config.workbench.sideBar.location", "left"), iconA: bi, iconB: vi }), ye(ke.ID, At, o("panel", "Panel"), Gd), ye(Ii.ID, E.equals("config.workbench.statusBar.visible", !0), o("statusBar", "Status Bar"), Od));
const qd = [
...
function Oo(p, e, t) {
  const i = p.get(Ge), n = p.get(T), r = $d(e, t, i, n);
  let s;
...
let ne = class extends $e {
  ...
  async getContents(e, t) {
    ...
    const n = i.getSize();
    return this.handleMetadataChanged(typeof n == "number" ? $o.formatSize(n) : ""), {
      icon: "$(warning)",
      label: o(
        "binaryError",
...
function Qe(p) {
  ...
  const e = p;
  return Yr(e.setEncoding, e.getEncoding) ? e : null;
}
function Lt(p) {
  if (p instanceof ot)
    return p;
...
const Ke = class Ke extends L {
  ...
  async run(e) {
    ...
    const P = n.getSortedRegisteredLanguageNames().map(({ languageName: te, languageId: Y }) => {
      const gt = n.getExtensions(Y).join(" ");
      let H;
      return A === te ? H = o("languageDescription", "({0}) - Configured Language", Y) : H = o("languageDescriptionConfigured", "({0})", Y), {
        label: te,
        meta: gt,
        iconClasses: po(Y),
        description: H
    ...
    if (D && b) {
      const te = go(b) || mo(b);
      $ = d.createInstance(Li, te), $.enabled && P.unshift($), le = { label: o(
    ...
    if (F) {
      ...
      if (te) {
        ...
        if (M === Ne) {
          if (S) {
            ...
            if (H) {
              ...
              (!ue || ue === "unknown") && (gt = await r.detectLanguage(H), ue = gt), ue && (Y = n.createById(ue));
            }
          }
        } else {
          const H = n.getLanguageIdByLanguageName(M.label);
          Y = n.createById(H), b && r.detectLanguage(b).then((ue) => {
            const Yn = n.getLanguageIdByLanguageName(M.label) || "unknown";
            if (ue === x && x !== Yn) {
        ...
        if (typeof Y < "u" && (te.setLanguageId(Y.languageId, Ke.ID), (b == null ? void 0 : b.scheme) === Dt.untitled)) {
...
class lc extends L {
  ...
  async run(e) {
    ...
    if (!$ || !t.activeEditorPane)
      return;
    const Ne = Qe(t.activeEditorPane.input);
    typeof $.id < "u" && Ne && await Ne.setEncoding($.id, x ? 1 : 0), a.focus();
  }
}
    ...
    this.editorLargeFileConfirmationConfigurationNode = {
      ...
      properties: {
        "workbench.editorLargeFileConfirmation": {
          type: "number",
          default: ns(this.environmentService.remoteAuthority) / $o.MB,
          minimum: 1,
          scope: 4,
          markdownDescription: o(
...
g.appendMenuItem(l.EditorTitleContext, { command: { id: yn, title: o("closeOthers", "Close Others"), precondition: Ya.notEqualsTo("1") }, group: "1_close", order: 20 });
...
g.appendMenuItem(l.EditorTitle, { command: { id: $a, title: o("inlineView", "Inline View"), toggled: E.equals("config.diffEditor.renderSideBySide", !1) }, group: "1_diff", order: 10, when: E.has("isInDiffEditor") });

import { _ as B, a as g, I as Pe, cR as M, aK as st, aZ as Hi, aj as Ks, g as Et, h as Ki, D as se, k as qs, ax as at, rG as fs, jV as wi, yt as rn, f4 as nn, qe as on, yu as an, S as H, yv as ze, bI as Ge, ds as Ot, dt as Ss, yw as cn, yx as ln, yy as hn, yz as un, yA as dn, yB as gn, yC as pn, e as N, b as Jt, bG as ht, yD as Zt, yE as qi, yF as fn, G as l, yG as Sn, fi as mn, yH as F, cL as Qi, l7 as vn, hj as le, yI as fe, yJ as L, l5 as yn, f as ei, cS as wn, bF as he, yK as bn, yL as xn, n as ti, r as In, e9 as En, t4 as Ui, F as rt, yM as Cn, jp as Qs, yN as Us, yO as ms, yP as zs, hf as li, yQ as hi, aw as z, bk as A, tz as We, dl as ft, dx as ii, cz as zi, aN as V, gk as $s, c5 as Q, rQ as Gs, bD as si, ab as ri, ag as ni, bH as $i, ac as nt, yR as ct, m5 as kn, xd as Rn, wu as Fn, bU as Pn, cb as $e, yS as js, yT as Xs, O as ut, t5 as Tn, yU as An, kt as vs, yV as Mn, yW as _n, yX as Gi, yY as ys, yZ as Ee, y as Ae, q as Wn, y_ as Ln, y$ as On, z0 as Dn, z1 as ws, z2 as ui, z3 as bs, z4 as ji, z5 as Nn, mm as xs, z6 as Bn, z7 as Vn, U as Le, kn as Is, ej as Hn, z8 as Ys, bE as ue, eE as Js, ap as Kn, jz as Zs, lu as Xi, cU as qn, z9 as Es, bL as Qn, Q as Me, hO as Yi, b9 as er, E as U, uw as Un, kI as bi, a1 as xi, ai as J, af as Ct, il as Ji, im as kt, za as oe, zb as zn, zc as X, bb as tr, $ as k, jh as $n, K as v, zd as Gn, ze as ir, eY as Cs, jg as jn, aJ as O, zf as _t, bM as Tt, tP as sr, tQ as rr, w as Rt, zg as Zi, aI as P, av as Dt, zh as Ii, zi as Xn, ad as es, a$ as Yn, p5 as Jn, zj as Zn, aT as eo, aR as nr, ba as or, bf as to, kH as io, j6 as ks, kK as Oe, vD as so, oH as ro, kJ as Wt, zk as no, cH as ts, cQ as oi, bX as ar, bh as ai, bz as oo, aG as y, zl as ao, fU as R, zm as ye, p as is, j4 as di, zn as co, lx as lo, iU as ss, pO as ho, fd as cr, zo as uo, r0 as go, aq as po, f2 as fo, dA as lr, rj as hr, hT as ur, hV as So, zp as Nt, be as mo, zq as dr, zr as pe, J as gi, a2 as me, b5 as ke, a4 as ve, b6 as St, vQ as pi, zs as Rs, zt as ci, B as Fs, b8 as gr, z as Ps, di as vo, tL as yo, zu as wo, zv as bo, zw as Ei, i8 as Re, kR as ot, hS as fi, zx as xo, gl as Io, uv as Eo, iB as Ci, o as Co, bR as ko, zy as Ro, zz as Fo, d9 as Lt, mh as ki, jd as Po, zA as To, cT as Ao, bY as Ft, ah as Mo, bW as _o, zB as rs, zC as Wo, ak as w, al as b, e2 as Lo, aM as Oo, fE as pr, gc as Do, fG as No, fH as Ri, gy as Bo, dC as Vo, fF as Ho, zD as Ko, zE as fr, zF as Sr, zG as mr, zH as qo, wE as Qo, zI as dt, c$ as Uo, dB as zo, at as vr, zJ as Ts, l as De, aC as $o, mv as Go, zK as jo, zL as Xo, h_ as Yo, kk as Jo, bB as yr, zM as Zo, jC as ea, eU as ta, zN as ia, u$ as sa, zO as ra, uG as na, pj as oa, sz as gt, zP as aa, x as ca, da as la, sE as ha, sR as At, eV as ua, j7 as da, dF as ga, zQ as As, j3 as pa, e6 as fa, jW as Sa, zR as ma } from "./verifyPrepare-778b382e.js";
import { ae as va } from "./debugCommands-1e928c6f.js";
import { b as ya, f as wa } from "./quickPickPin-1d33fc54.js";
let Fi = class extends se {
  ...
  registerSearchResultProvider(e, t, i) {
    ...
    return s.set(e, i), r.has(e) && (r.get(e).complete(i), r.delete(e)), qs(() => {
      s.delete(e);
    });
  }
...
let Vt = (q = class extends Ui {
  ...
  constructor(e, t, i, s, r, n, a, c, h, u, d, f, p, S, m, I, x) {
    super(q.PREFIX, {
      canAcceptInBackground: !0,
      noResultsPick: q.NO_RESULTS_PICK
  ...
  decorateAndRevealSymbolRange(e) {
    ...
    return i ? (this.pickState.rememberEditorViewState(), i.revealRangeInCenter(e.range.selection, 0), this.addDecorations(i, e.range.decoration), qs(() => this.clearDecorations(i))) : se.None;
  }
  _getPicks(e, t, i, s) {
    var u, d;
    ...
    if (c && h) {
      const f = mi(h), p = h === q.NO_RESULTS_PICK && n.indexOf(Ee.PREFIX) >= 0;
  ...
  doGetPicks(e, t, i, s) {
    ...
    return this.pickState.isQuickNavigating ? c = a : (c = [], t.includeHelp && c.push(...this.getHelpPicks(r, s, t)), a.length !== 0 && (c.push({ type: "separator", label: l("recentlyOpenedSeparator", "recently opened") }), c.push(...a))), {
      ...
      mergeDelay: q.SYMBOL_PICKS_MERGE_DELAY
    };
  }
  async getAdditionalPicks(e, t, i) {
    ...
    if (i.isCancellationRequested)
      return [];
    const n = Dn([...s, ...r], (c, h) => bs(c, h, e, !0, ui, this.pickState.scorerCache), q.MAX_RESULTS), a = [];
    for (const c of n)
      if (c.highlights)
        a.push(c);
      else {
  ...
  getHelpPicks(e, t, i) {
    ...
    const n = [], a = (c, h = {}) => {
      if (r.has(c)) {
        ...
        const d = {
          ...i,
          includeHelp: u.prefix === q.PREFIX ? !1 : i == null ? void 0 : i.includeHelp
        };
        n.push({
          ...r.get(c),
          ...h,
    ...
    return a(q.PREFIX), a(Bn.PREFIX), a(Ee.PREFIX), a(va), a(Mi.PREFIX), a(ys.PREFIX, {
      label: l("more", "More")
    }), n;
  }
...
}, q.PREFIX = "", q.NO_RESULTS_PICK = {
  label: l("noAnythingResults", "No matching results")
}, q.MAX_RESULTS = 512, q.TYPING_SEARCH_DELAY = 200, q.SYMBOL_PICKS_MERGE_DELAY = 200, q);
Vt = B([
  g(0, N),
  g(1, Ys),
  g(2, ue),
...
function Ka(o, e) {
  return e ? !e || o.includes(e) || qa(o, e) : !1;
}
function qa(o, e) {
  for (const t of o)
...
const K = new O("inSearchEditor", !1), cs = "search-editor", Lr = "search/editor", Os = "searchEditorFindMatch", Li = "workbench.editor.searchEditor", Fc = "search.action.openNewEditor", wt = "search.action.openEditor", Or = "toggleSearchEditorContextLines", Oi = "workbench.editorinputs.searchEditorInput";
class Pc extends se {
  get markupInput() {
...
`;
  ...
  const d = (p, S) => ye(p, S, r), f = $c(wi(o.folderMatches().sort(d).map((p) => p.allDownstreamFileMatches().sort(d).flatMap((S) => Kc(S, s)))));
  return {
...
class jc {
  ...
  initializeModelFromExistingFile(e, t, i) {
    ...
    this.models.set(t, {
      resolve: async () => (c || (c = (async () => {
        ...
        if (h)
          return h;
        const { text: u, config: d } = await n.invokeFunction(Kr, i);
        return {
  ...
  async tryFetchModelFromBackupService(e, t, i, s, r) {
    ...
    if (a) {
      const c = a.getValue(), { text: h, config: u } = qr(c);
...
` + t.getValue();
  ...
  async revert(e, t) {
    ...
    if (this.backingUri) {
      const { config: i, text: s } = await this.instantiationService.invokeFunction(Kr, this.backingUri), { resultsModel: r, configurationModel: n } = await this.resolveModels();
...
let Ni = (it = class extends So {
  ...
  renderBody(e) {
    ...
    v(d, j("h4", void 0, f)), this.inputPatternIncludes = this._register(this.instantiationService.createInstance(Kt, d, this.contextViewService, {
      ariaLabel: f,
    ...
    v(p, j("h4", void 0, S)), this.inputPatternExcludes = this._register(this.instantiationService.createInstance(qt, p, this.contextViewService, {
      ariaLabel: S,
...
w(class extends b {
  constructor() {
    super({
      ...
      keybinding: {
        weight: 200,
        when: y.or(y.and(K, je), y.and(Z, je)),
        primary: 2066
      }
    });
  }
...
function ml(o, e) {
  ...
  return i ? o.get(Ki).extUri.isEqual(i, e.parent().resource) : !1;
}
function vl(o, e) {
...
let xt = (Ke = class extends ea {
  ...
  createEditor(e) {
    ...
    K.bindTo(i).set(!0), this.createQueryEditor(this.queryEditorContainer, this.instantiationService.createChild(new Rt([J, i])), je.bindTo(i));
  }
  createQueryEditor(e, t, i) {
    ...
    v(r, k("h4", void 0, n)), this.inputPatternIncludes = this._register(t.createInstance(Kt, r, this.contextViewService, {
    ...
    v(a, k("h4", void 0, c)), this.inputPatternExcludes = this._register(t.createInstance(qt, a, this.contextViewService, {
...
}, Ke.ID = Li, Ke.SEARCH_EDITOR_VIEW_STATE_PREFERENCE_KEY = "searchEditorViewState", Ke);
xt = B([
  g(0, st),
  g(1, ni),
  g(2, nt),
...
const _l = "search.action.openInEditor", Wl = "search.action.openNewEditorToSide", Ll = "search.action.focusQueryEditorWidget", Ol = "search.action.focusFilesToInclude", Dl = "search.action.focusFilesToExclude", Nl = "toggleSearchEditorCaseSensitive", Bl = "toggleSearchEditorWholeWord", Vl = "toggleSearchEditorRegex", Hl = "increaseSearchEditorContextLines", Kl = "decreaseSearchEditorContextLines", ql = "rerunSearchEditorSearch", Ql = "cleanSearchEditorState", Ul = "selectAllSearchEditorMatches";
...
w(class extends b {
  ...
  async run(o) {
    o.get(J).getContext(document.activeElement).getValue(K.serialize()) && o.get(M).activeEditorPane.deleteResultBlock();
  }
});
w(class extends b {
  constructor() {

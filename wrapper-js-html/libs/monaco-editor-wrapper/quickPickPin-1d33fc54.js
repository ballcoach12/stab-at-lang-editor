import { c5 as t, G as e, bk as s, aw as g } from "./verifyPrepare-778b382e.js";
t("extensions-view-icon", s.extensions, e("extensionsViewIcon", "View icon of the extensions view."));
const B = t("extensions-manage", s.gear, e(
  "manageExtensionIcon",
...
async function $(o, i, n, l) {
  const a = n.items;
  let c = p(i, n, o, void 0, l);
  n.onDidTriggerItemButton(async (r) => {
    r.button.iconClass && y.includes(r.button.iconClass) && (n.items = a, c = p(i, n, o, r.item, l), n.items = n.value ? a : c);
  }), n.onDidChangeValue(async (r) => {
    n.items === c && r ? n.items = a : n.items === a && !r && (n.items = c);
  }), n.items = n.value ? a : c, n.show();
}
function p(o, i, n, l, a) {
  const c = [];
  let r;
  ...
  for (const h of r) {
    ...
    if (I) {
      const m = d(I), w = Object.assign({}, I);
      (!a || !f.has(m)) && (f.add(m), u(w, !1), c.push(w));
    }
  }

import { ql as M, qm as A } from "./verifyPrepare-778b382e.js";
function I(p, m) {
    ...
    if (typeof a != "string" && !Array.isArray(a)) {
      for (const c in a)
        if (c !== "default" && !(c in p)) {
          ...
          g && Object.defineProperty(p, c, g.get ? g : {
            enumerable: !0,
            get: () => a[c]
          });
        }
      ...
      return (() => {
        ...
        class g {
          ...
          serialize(t) {
            ...
            for (let u = o; u <= n; u++) {
              const d = this._buffer.getLine(u);
              if (d) {
                const _ = u !== t.start.x ? 0 : r, k = u !== t.end.x ? d.length : h;
                for (let w = _; w < k; w++) {
                  const b = d.getCell(w, l === e ? s : e);
                  b ? (this._nextCell(b, l, u, w), l = b) : console.warn(`Can't get cell at row=${u}, col=${w}`);
                }
              }
              this._rowEnd(u, u === n);
            }
        ...
        class z extends g {
          ...
          _rowEnd(t, e) {
            ...
            if (!e) {
              ...
              if (n.isWrapped) {
                l = "";
                const r = o.getCell(o.length - 1, this._thisRowLastChar), h = o.getCell(o.length - 2, this._thisRowLastSecondChar), u = n.getCell(0, this._nextRowFirstChar), d = u.getWidth() > 1;
                let _ = !1;
                (u.getChars() && d ? this._nullCellCount <= 1 : this._nullCellCount <= 0) && ((r.getChars() || r.getWidth() === 0) && C(r, u) && (_ = !0), d && (h.getChars() || h.getWidth() === 0) && C(r, u) && C(h, u) && (_ = !0)), _ || (l = "-".repeat(this._nullCellCount + 1), l += "\x1B[1D\x1B[1X", this._nullCellCount > 0 && (l += "\x1B[A", l += `\x1B[${o.length - this._nullCellCount}C`, l += `\x1B[${this._nullCellCount}X`, l += `\x1B[${o.length - this._nullCellCount}D`, l += "\x1B[B"), this._lastContentCursorRow = t + 1, this._lastContentCursorCol = 0, this._lastCursorRow = t + 1, this._lastCursorCol = 0);
              } else
                l = `\r
`, this._lastCursorRow = t + 1, this._lastCursorCol = 0;
          ...
          _diffStyle(t, e) {
            const s = [], l = !S(t, e), o = !C(t, e), n = !R(t, e);
            if (l || o || n)
        ...
        a.SerializeAddon = class {
          ...
          _serializeBuffer(i, t, e) {
            const s = t.length, l = new z(t, i), o = e === void 0 ? s : c(e + i.rows, 0, s);
            return l.serialize({ start: { x: s - o, y: 0 }, end: { x: s - 1, y: i.cols } });
          }
          _serializeBufferAsHTML(i, t) {
            var e, s;
            const l = i.buffer.active, o = new y(l, i, t);
            if ((e = t.onlySelection) === null || e === void 0 || !e) {
              const r = l.length, h = t.scrollback, u = h === void 0 ? r : c(h + i.rows, 0, r);
        ...
        class y extends g {
          ...
          _beforeSerialize(t, e, s) {
            ...
            let u = "#000000", d = "#ffffff";
            (l = this._options.includeGlobalBackground) !== null && l !== void 0 && l && (u = (n = (o = this._terminal.options.theme) === null || o === void 0 ? void 0 : o.foreground) !== null && n !== void 0 ? n : "#ffffff", d = (h = (r = this._terminal.options.theme) === null || r === void 0 ? void 0 : r.background) !== null && h !== void 0 ? h : "#000000");
            const _ = [];
            _.push("color: " + u + ";"), _.push("background-color: " + d + ";"), _.push("font-family: " + this._terminal.options.fontFamily + ";"), _.push("font-size: " + this._terminal.options.fontSize + "px;"), this._htmlContent += "<div style='" + _.join(" ") + "'>";
          }
          _afterSerialize() {
        ...
        a.HTMLSerializeHandler = y;
      })(), f;
    })());
  }(v)), v.exports;
}
var B = F();
const $ = /* @__PURE__ */ A(B), L = /* @__PURE__ */ I({
  __proto__: null,
  default: $
}, [B]);
export {

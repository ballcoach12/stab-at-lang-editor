import { qm as k } from "./verifyPrepare-778b382e.js";
function P(R, A) {
          ...
          _findInLine(e, t, s = {}, i = !1) {
            ...
            if (p >= 0) {
              ...
              for (; u < L.length - 1 && p + e.length >= L[u + 1]; )
                u++;
              const W = p - L[f], E = p + e.length - L[u], O = this._stringLengthToBufferSize(r + f, W);
              return { term: e, col: O, row: r + f, size: this._stringLengthToBufferSize(r + u, E) - O + n.cols * (u - f) };
            }
          }
...
var z = Y();
const j = /* @__PURE__ */ k(z), $ = /* @__PURE__ */ P({
  __proto__: null,
  default: j
}, [z]);
export {

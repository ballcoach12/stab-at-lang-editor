import { D as O, $ as S, G as Fe, B as d, oF as Pe, oG as De, a0 as R, a2 as Be, b6 as Ce, lQ as Ae, oH as Ee, oI as Ie, b3 as B, b4 as te, b9 as ie, au as x, bi as F, b8 as We, aP as Te, x as Ue, bf as Le, fi as Re, e0 as ue, oJ as Ne, cB as Oe, eW as W, w as He, lR as _e, oK as Me, kH as qe, oL as Ve, _ as T, a as c, aX as H, k$ as fe, ad as G, e as Y, aU as me, cO as ge, oM as Ke, bF as Z, N as $e, hM as je, E as M, f2 as ze, an as ee, aH as Qe, g as pe, bB as Xe, bD as Se, bC as ve, a9 as Je, f0 as U, I as Ge, bE as be, oN as Ye, eC as ye, ag as Ze, bV as et, S as g, cP as ke, cK as b, ao as D, m3 as tt, U as se, mk as we, fb as I, cJ as v, kN as it, oO as k, oP as E, oQ as st, oR as ae, oS as P, oT as oe, at as ne, oU as _, oV as at, oW as ot, oX as nt, bJ as re, bK as rt, d as lt, bv as ht, ls as ct, aL as dt, cx as ut, bA as ft, bW as mt, gi as gt, jw as pt, kC as St, oY as vt, fq as bt, oZ as yt, eU as le, o_ as kt, av as he, fw as wt, o$ as N, p0 as xt, k as ce, li as Ft, lB as Pt } from "./index-7e82f14c.js";
import { i as Dt, b as Bt } from "./window-d3fbdde0.js";
...
const At = $e.as(je.Workbench);
At.registerWorkbenchContribution(V, 1);
class Et extends O {
  constructor() {
    super(...arguments), this.dialogs = [], this._onWillShowDialog = this._register(new M()), this.onWillShowDialog = this._onWillShowDialog.event, this._onDidShowDialog = this._register(new M()), this.onDidShowDialog = this._onDidShowDialog.event;
  }
  show(e) {
    const t = new ze(), i = {
      args: e,
...
let X = class {
  constructor(e, t, i, s, a, o, l, n, u, r, h, m, p, w) {
    this.fileService = e, this.quickInputService = t, this.labelService = i, this.workspaceContextService = s, this.notificationService = a, this.fileDialogService = o, this.modelService = l, this.languageService = n, this.environmentService = u, this.remoteAgentService = r, this.pathService = h, this.keybindingService = m, this.accessibilityService = w, this.hidden = !1, this.allowFileSelection = !0, this.allowFolderSelection = !1, this.requiresTrailing = !1, this.userEnteredPathSegment = "", this.autoCompletePathSegment = "", this.isWindows = !1, this.separator = "/", this.onBusyChangeEmitter = new M(), this.disposables = [
  ...
  async pickResource(e = !1) {
    ...
    return new Promise((a) => {
      if (this.filePickBox = this.quickInputService.createQuickPick(), this.busy = !0, this.filePickBox.matchOnLabel = !1, this.filePickBox.sortByLabel = !1, this.filePickBox.autoFocusOnList = !1, this.filePickBox.ignoreFocusOut = !0, this.filePickBox.ok = !0, this.scheme !== g.file && this.options && this.options.availableFileSystems && this.options.availableFileSystems.length > 1 && this.options.availableFileSystems.indexOf(g.file) > -1) {
        ...
        let r;
        e ? r = j : r = this.allowFileSelection ? this.allowFolderSelection ? Q : $ : z;

import { G as c, ej as G, sw as q, dl as ot, dx as at, S as Ut, kE as Ht, U as ce, rF as Kt, jy as qt, lx as Gt, cb as Ye, aE as $, _ as Q, a as S, f as zt, h as Wt, aZ as Xt, rC as jt, az as ae, E as fe, zS as Jt, f4 as Yt, be as rt, fy as ct, zT as $t, hj as be, cO as Qt, D as Zt, zU as ei, r0 as $e, zV as ti, rK as ii, c5 as h, bk as l, ad as dt, r7 as g, af as ni, e as si, ag as oi, cR as R, cH as ai, aN as He, ah as ri, ai as le, cz as ci, aK as di, bF as Z, aP as ui, aO as li, bG as ut, K as f, d1 as M, ba as _e, cL as lt, aw as he, b7 as Ke, d as F, oH as ht, kJ as pt, a2 as gt, ak as O, al as V, aI as k, aG as B, tC as ee, rp as z, zW as L, sa as Te, s8 as te, sY as qe, zX as Ge, hS as pe, so as hi, aR as Qe, $ as pi, a5 as gi, hV as fi, zY as ft, p7 as bi, zZ as Ae, he as mi, J as Ze, b$ as Si, sF as ki, ji as vi, z as Ii, c$ as Ci, bD as ie, I as Bi, y as bt, t5 as Fe, bL as wi, fU as ze, bY as Di, se as de, bB as v, ri as yi, cQ as Ei, sb as Oe, ab as mt, bO as St, rX as xi, fQ as Ne, bz as I, t_ as kt, bT as vt, s6 as ne, rW as _i, rU as It, wc as Ti, dC as se, i5 as We, u3 as Ct, tg as Ai, rR as Oi, cu as Ni, e2 as Li } from "./verifyPrepare-778b382e.js";
  ...
  async fetchVariables(e, t, i) {
    try {
      ...
      const s = /* @__PURE__ */ new Map(), a = n.body.variables.filter((r) => !!r).map((r) => {
        if (Ye(r.value) && Ye(r.name) && typeof r.variablesReference == "number") {
...
class Fn extends Zt {
  ...
  async read(e, t) {
    ...
    if (a.byteLength < d) {
      const p = $e.alloc(d - a.byteLength);
      p.buffer.fill(0), a = $e.concat([a, p], d);
    } else
...
class w extends ge {
  constructor(e, t, i, n, s, a, r, d, u, p, b, C = $()) {
...
class A extends ge {
  constructor(e, t, i, n, s, a, r, d, u, p = $()) {
...
class W extends ge {
  constructor(e, t, i, n, s, a, r, d = !1) {
    super(i, void 0, s, void 0, $()), this.filter = e, this.label = t, this.supportsCondition = n, this.description = a, this.conditionDescription = r, this.fallback = d, this.supportedSessions = /* @__PURE__ */ new Set();
  }
  toJSON() {
    const e = /* @__PURE__ */ Object.create(null);

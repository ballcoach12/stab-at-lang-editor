import { _ as x, a, aK as k, ac as E, e as F, ag as B, ad as K, aj as R, bE as O, Q as y, yn as Y, yo as Z, bQ as ee, aH as ie, aT as te, yp as ne, yq as se, aN as oe, ae as I, ah as m, aC as re, aM as ae, ai as J, D as ce, E as U, k as G, yr as N, ys as de, aJ as le, y as P, am as M, ak as b, al as S, G as p, aG as C, ca as z, dA as H, fU as A, bO as q, aI as D, cb as we, U as he, O as ue } from "./verifyPrepare-778b382e.js";
...
let j = class extends ce {
  constructor(e, i, t, n) {
    super(), this.viewDescriptorService = e, this.paneCompositeService = i, this.contextKeyService = t, this.layoutService = n, this._onDidChangeViewVisibility = this._register(new U()), this.onDidChangeViewVisibility = this._onDidChangeViewVisibility.event, this._onDidChangeViewContainerVisibility = this._register(new U()), this.onDidChangeViewContainerVisibility = this._onDidChangeViewContainerVisibility.event, this.viewDisposable = /* @__PURE__ */ new Map(), this.visibleViewContextKeys = /* @__PURE__ */ new Map(), this.viewPaneContainers = /* @__PURE__ */ new Map(), this._register(G(() => {
  ...
  registerOpenViewAction(e) {
    ...
    if (e.openCommandActionDescriptor) {
      ...
      if (i.add(b(class extends S {
        ...
        async run(r) {
          const c = r.get(H), d = r.get(m), l = r.get(I), h = r.get(A), u = r.get(J);
          if (N.getValue(u) === e.id) {
